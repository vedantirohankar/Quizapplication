...
class Quiz:
    ...
    def question(self, qn):
        t = Label(root, text="Quiz in C  Programming", width=50, bg="black", fg="white", font=("times", 20, "bold"))
        t.place(x=0, y=2)
        self.quest.set(str(self.qno) + ". " + q[qn])
        qn = Label(root, textvariable=self.quest, width=70, font=("times", 16, "bold"), anchor="w")
        qn.place(x=70, y=100)
        return qn
    ...
    def buttons(self):
        nbutton = Button(root, text="Next", command=self.nextbtn, width=10, bg="blue", fg="white",
                         font=("times", 16, "bold"))
